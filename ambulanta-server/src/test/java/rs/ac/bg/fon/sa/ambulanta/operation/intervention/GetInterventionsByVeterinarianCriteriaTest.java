...
class GetInterventionsByVeterinarianCriteriaTest {

	private GetInterventionsByVeterinarianCriteria so;
    ...
    public void setUp() throws Exception {
        so = new GetInterventionsByVeterinarianCriteria();
        dbBroker = new DbBroker();

        owner = (Owner) dbBroker.add(new Owner(null, "Pera", "Peric", "1234567890123", false, "0611234567", "pera@vetcriteria.com", "Bulevar oslobodjenja 1"));
        veterinarian = (Veterinarian) dbBroker.add(new Veterinarian(null, "Marko", "Markovic", LocalDate.of(1990, 5, 20), "0641234567", "marko@vetcriteria.com", "sifra123"));
    ...
    @Test
    public void testExecuteOperationByVeterinarianId() throws Exception {
        so.execute(String.valueOf(veterinarian.getId()));
    ...
    @Test
    public void testExecuteOperationByVeterinarianLastnameFull() throws Exception {
        so.execute("MarkovicLastname");
    ...
    @Test
    public void testExecuteOperationByVeterinarianLastnamePartial() throws Exception {
        so.execute("MarkLastname");
    ...
    @Test
    public void testExecuteOperationMultipleByVeterinarianId() throws Exception {
    ...
    @Test
    public void testExecuteOperationMultipleByVeterinarianLastname() throws Exception {
        Intervention intervention2 = new Intervention(null, LocalDate.of(2025, 8, 19), "Kontrola", 0, 0, 1200.0, 1200.0, veterinarian, animal, new ArrayList<>());
        intervention2 = (Intervention) dbBroker.add(intervention2);
        DbConnectionFactory.getInstance().getConnection().commit();
    ...
    @Test
    public void testExecuteOperationNoMatchingVeterinarianId() throws Exception {
        so.execute("0");
    ...
    public void testExecuteOperationNoMatchingVeterinarian() throws Exception {
        so.execute("NepostojeciLastname");
